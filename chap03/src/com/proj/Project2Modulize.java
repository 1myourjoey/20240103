...
public class Project2Modulize {
//=======================================================================================================
	public static int withdraw(boolean loginStatus, boolean run2, Scanner scanner, int balance) {
...
//				membershipStatus = true;
				...
				break;
			case 3:
				balance = withdraw(loginStatus, run2, scanner, balance);
				break;
			case 4:
				run = false;
				break;
